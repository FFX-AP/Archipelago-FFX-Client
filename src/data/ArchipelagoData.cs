...
public static class ArchipelagoData {
    ...
    public static Dictionary<uint, string> overdrive_names = new Dictionary<uint, string>()
    {
        ...
        {PlayerCommandId.PCOM_ELEMENT_REELS,    "Reels: Element Reels"      },
        {PlayerCommandId.PCOM_ATTACK_REELS,     "Reels: Attack Reels"       },
        {PlayerCommandId.PCOM_STATUS_REELS,     "Reels: Status Reels"       },
        {PlayerCommandId.PCOM_AUROCHS_REELS,    "Reels: Aurochs Reels"      },
