...
public unsafe partial class DeathLinkModule : FhModule {
    ...
    private string _get_deathlink_send_text(string player) {
        ...
        string message_id = "deathlink.sent_message." + encounter_name switch {
            ...
            "cdsp07_00" => $"tros.{boss_rng}",
            "bsil04_00" => $"kimahri.{boss_rng}",
            "slik02_00" => $"sin_fin.{boss_rng}",
            "slik02_01" => $"sinspawn_echuiless.{boss_rng}",
            "klyt00_00" => $"lord_ochu.{boss_rng}",
            "klyt01_00" => $"sinspawn_geneaux.{boss_rng}",
            "cdsp02_00" => $"oblitzerator.{boss_rng}",
            "mihn02_00" => $"chocobo_eater.{boss_rng}",
            "kino02_00" or "kino03_10" => $"sinspawn_gui.{boss_rng}",
            "genk09_00" => $"extractor.{boss_rng}",
            "mcfr03_00" => $"spherimorph.{boss_rng}",
            "maca02_00" => $"crawler.{boss_rng}",
            "mcyt06_00" => $"seymour.{boss_rng}",
            "maca02_01" => $"wendigo.{boss_rng}",
            "hiku15_00" => $"evrae.{boss_rng}",
            "stbv00_10" or "stbv00_11" or "stbv00_12" => $"evrae_altana.{boss_rng}",
            "bvyt09_10" or "bvyt09_11" or "bvyt09_12" => $"isaaru.{boss_rng}",
            "stbv01_10" => $"seymour_natus.{boss_rng}",
            "nagi01_00" => $"defender_x.{boss_rng}",
            "nagi05_10" => $"lady_ginnem.{boss_rng}",
            "mtgz01_10" => $"biran_and_yenke.{boss_rng}",
            "mtgz02_00" => $"seymour_flux.{boss_rng}",
            "mtgz08_00" => $"sanctuary_keeper.{boss_rng}",
            "dome02_00" => $"spectral_keeper.{boss_rng}",
            "dome06_00" => $"yunalesca.{boss_rng}",
            "ssbt00_00" or "ssbt01_00" => $"sin_fins.{boss_rng}",
            "ssbt02_00" => $"sin_core.{boss_rng}",
            "ssbt03_00" => $"overdrive_sin.{boss_rng}",
            ...
            "bjyt02_01" or "bjyt02_02" => $"geosgaeno.{boss_rng}",

            "bsil07_70" => $"dark_valefor.{boss_rng}",
            "bika03_70" => $"dark_ifrit.{boss_rng}",
            "kami03_70" or "kami03_71" => $"dark_ixion.{boss_rng}",
            "mcyt00_70" => $"dark_shiva.{boss_rng}",
            "dome06_70" => $"dark_bahamut.{boss_rng}",
            "mtgz01_70" => $"dark_anima.{boss_rng}",
            "nagi05_70" or "nagi05_71" or "nagi05_72" or "nagi05_73" or "nagi05_74" => $"dark_yojimbo.{boss_rng}",
            "kino00_70" or "kino01_70" or "kino01_72" => $"dark_magus_sisters.{boss_rng}",
            "kino05_70" => $"dark_sandy.{boss_rng}",
            "kino05_71" => $"dark_mindy.{boss_rng}",
            "kino01_71" => $"dark_cindy.{boss_rng}",
